...
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe, is_ativo) SELECT 189, 'MOVIMENTOS RECEBER SOCIAL', '"/Sindical/movimentosReceberSocial.jsf"', '', true WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 189);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe, is_ativo) SELECT 190, 'ALTERAR MOVIMENTO', '"/Sindical/alterarMovimento.jsf"', '', true WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 190 );
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe, is_ativo) SELECT 191, 'PESQUISAR TURMA', '"/Sindical/pesquisaTurma.jsf"', '', true WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 191 );
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe, is_ativo) SELECT 192, 'PESQUISAR MATRÍCULA ESCOLA', '"/Sindical/pesquisaMatriculaEscola.jsf"', '', true WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 192 );
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe, is_ativo) SELECT 193, 'MODELO CONTRATO', '"/Sindical/modeloContrato.jsf"', '', true WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 193 );
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe, is_ativo) SELECT 194, 'PESQUISA MODELO CONTRATO', '"/Sindical/pesquisaModeloContrato.jsf"', '', true WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 194 );
...
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe, is_ativo) SELECT 200, 'ACADEMIA - TABELA DE PREÇOS', '"/Sindical/academiaServicoValor.jsf"', '', true WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 200);
...
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe, is_ativo) SELECT 209, 'AGRUPA TURMA', '"/Sindical/agrupaTurma.jsf"', '', true WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 209);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe, is_ativo) SELECT 210, 'PESQUISA AGRUPA TURMA', '"/Sindical/pesquisaAgrupaTurma.jsf"', '', true WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 210);
...
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe, is_ativo) SELECT 226, 'RELATÓRIO CONVITE CLUBE', '"/Sindical/relatorioConviteClube.jsf"', '', true WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 226);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe, is_ativo) SELECT 227, 'RESCISÃO DE CONTRATO', '"/Sindical/rescisaoMatricula.jsf"', '', true WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 227);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe, is_ativo) SELECT 228, 'MATRÍCULA CONCLUSÃO', '"/Sindical/conclusaoMatricula.jsf"', '', true WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 228);
...
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe, is_ativo) SELECT 240, 'FILIAL DEPARTAMENTO', '"/Sindical/filialDepartamento.jsf"', '', true WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 240);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe, is_ativo) SELECT 241, 'PREVISÃO PAGAMENTO', '"/Sindical/previsaoPagamento.jsf"', '', true WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 241);
...
INSERT INTO sis_relatorios (id, ds_nome, ds_jasper, id_rotina, ds_qry_ordem, ds_qry) SELECT 3,'Contribuintes por Escritório Alfabético','/Relatorios/CONTRIBUINTESPORESCRITORIO.jasper',5,'conpes.ds_nome,conpes.id,p.ds_nome','' WHERE NOT EXISTS ( SELECT id FROM sis_relatorios WHERE id = 3);
