...
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe, is_ativo) SELECT 56, 'MOTIVO INATIVAÇÃO', '"/Sindical/motivoInativacao.jsf"', 'MotivoInativacao' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 56);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe, is_ativo) SELECT 57, 'CONVENÇÃO', '"/Sindical/convencao.jsf"', 'Convencao' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 57);
...
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe, is_ativo) SELECT 59, 'TIPO SERVIÇO', '"/Sindical/tipoServico.jsf"', 'TipoServico' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 59);
...
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe, is_ativo) SELECT 63, 'EVENTO', '"/Sindical/evento.jsf"', 'Evento' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 63);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe, is_ativo) SELECT 64, 'MÓDULO', '"/Sindical/modulo.jsf"', 'Modulo' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 64);
...
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe, is_ativo) SELECT 69, 'DEPARTAMENTO', '"/Sindical/departamento.jsf"', 'Departamento' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 69);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe, is_ativo) SELECT 70, 'NÍVEL', '"/Sindical/nivel.jsf"', 'Nivel' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 70);
...
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe, is_ativo) SELECT 74, 'BAIRRO', '"/Sindical/bairro.jsf"', 'Bairro' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 74);
...
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe, is_ativo) SELECT 76, 'DESCRIÇÃO ENDEREÇO', '"/Sindical/descricaoEndereco.jsf"', 'DescricaoEndereco' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 76);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe, is_ativo) SELECT 77, 'LOGRADOURO', '"/Sindical/logradouro.jsf"', 'Logradouro' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 77);
...
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe, is_ativo) SELECT 79, 'TIPO ENDEREÇO', '"/Sindical/tipoEndereco.jsf"', 'TipoEndereco' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 79);
...
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe, is_ativo) SELECT 83, 'TIPO DOCUMENTO', '"/Sindical/tipoDocumento.jsf"', 'TipoDocumento' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 83);
...
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe, is_ativo) SELECT 89, 'GRUPO AGENDA', '"/Sindical/grupoAgenda.jsf"', 'GrupoAgenda' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 89);
...
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe, is_ativo) SELECT 102, 'GRUPO CIDADE', '"/Sindical/grupoCidade.jsf"', 'GrupoCidade' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 102);
...
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe, is_ativo) SELECT 108, 'ÍNDICE', '"/Sindical/indice.jsf"', 'Indice' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 108);
...
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe, is_ativo) SELECT 125, 'GRUPO CONVÊNIO', '"/Sindical/grupoConvenio.jsf"', 'GrupoConvenio' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 125);
...
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe, is_ativo) SELECT 149, 'COMPONENTE CURRICULAR', '"/Sindical/componenteCurricular.jsf"', 'ComponenteCurricular' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 149);
...
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe, is_ativo) SELECT 155, 'TIPO PAGAMENTO', '"/Sindical/tipoPagamento.jsf"', 'TipoPagamento' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 155);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe, is_ativo) SELECT 156, 'GRUPO EVENTO', '"/Sindical/grupoEvento.jsf"', 'GrupoEvento' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 156);
...
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe, is_ativo) SELECT 159, 'MÍDIA', '"/Sindical/midia"', 'Midia' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 159);
...
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe, is_ativo) SELECT 162, 'GENERO', '"/Sindical/genero.jsf"', 'Genero' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 162);
...
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe, is_ativo) SELECT 164, 'REGISTRO PATRONAL', '"/Sindical/registroPatronal.jsf"', 'Patronal' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 164);
...
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe, is_ativo) SELECT 166, 'ATENDIMENTO OPERAÇÃO', '"/Sindical/atendimentoOperacao.jsf"', 'AteOperacao' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 166);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe, is_ativo) SELECT 167, 'ATENDIMENTO PESSOA', '', 'AtePessoa' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 167);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe, is_ativo) SELECT 168, 'ATENDIMENTO MOVIMENTO', '"/Sindical/atendimento.jsf"', 'AteMovimento' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 168);
