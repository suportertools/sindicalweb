...
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 1, 'CAIXA BANCO', '/Sindical/caixaBanco.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 1);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 2, 'Inátivo (2)', '', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 2);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 3, 'Inátivo (3)', '', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 3);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 4, 'ARRECADAÇÃO', '', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 4);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 5, 'RELATÓRIO CONTRIBUINTES', '"/Sindical/relatorioContribuintes.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 5);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 6, 'RELATÓRIO CONTABILIDADES', '"/Sindical/relatorioContabilidades.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 6);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 7, 'MENU PRINCIPAL', '"/Sindical/menuPrincipal.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 7);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 8, 'MENU FINANCEIRO', '"/Sindical/menuFinanceiro.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 8);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 9, 'MENU ARRECADAÇÃO', '"/Sindical/menuArrecadacao.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 9);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 10, 'MENU SOCIAL', '"/Sindical/menuSocial.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 10);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 11, 'MENU HOMOLOGAÇÃO', '"/Sindical/menuHomologacao.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 11);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 12, 'MENU ACADEMIA', '"/Sindical/menuAcademia.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 12);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 13, 'MENU ESCOLA', '"/Sindical/menuEscola.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 13);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 14, 'MENU CLUBE', '"/Sindical/menuClube.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 14);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 15, 'PESQUISA BAIRRO', '"/Sindical/pesquisaBairro.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 15);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 16, 'PESQUISA CIDADE', '"/Sindical/pesquisaCidade.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 16);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 17, 'PESQUISA DESCRIÇÃO ENDEREÇO', '"/Sindical/pesquisaDescricaoEndereco.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 17);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 18, 'PESQUISA LOGRADOURO', '"/Sindical/pesquisaLogradouro.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 18);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 19, 'PESQUISA ENDEREÇO', '"/Sindical/pesquisaEndereco.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 19);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 20, 'PESQUISA TIPO ENDEREÇO', '"/Sindical/pesquisaTipoEndereco.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 20);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 21, 'PESQUISA PROFISSÃO', '"/Sindical/pesquisaProfissao.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 21);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 22, 'PESQUISA FILIAL', '"/Sindical/pesquisaFilial.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 22);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 23, 'PESQUISA CONSELHO', '"/Sindical/pesquisaConselho.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 23);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 24, 'PESQUISA CNAE', '"/Sindical/pesquisaCnae.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 24);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 25, 'PESQUISA USUÁRIO', '"/Sindical/pesquisaUsuario.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 25);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 26, 'PESQUISA DEPARTAMENTO', '"/Sindical/pesquisaDepartamento.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 26);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 27, 'PESQUISA NÍVEL', '"/Sindical/pesquisaNivel.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 27);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 28, 'PESQUISA PESSOA', '"/Sindical/pesquisaPessoa.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 28);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 29, 'PESQUISA PESSOA FISÍCA', '"/Sindical/pesquisaPessoaFisica.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 29);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 30, 'PESQUISA TIPO DOCUMENTO', '"/Sindical/pesquisaTipoDocumento.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 30);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 31, 'PESQUISA PESSOA JURIDICA', '"/Sindical/pesquisaPessoaJuridica.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 31);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 32, 'PESQUISA JURIDICA FILIAL', '"/Sindical/pesquisaJuridicaFilial.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 32);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 33, 'PESQUISA PLANO', '"/Sindical/pesquisaPlano.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 33);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 34, 'PESQUISA PLANO 2', '"/Sindical/pesquisaPlano2.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 34);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 35, 'PESQUISA PLANO 3', '"/Sindical/pesquisaPlano3.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 35);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 36, 'PESQUISA PLANO 4', '"/Sindical/pesquisaPlano4.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 36);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 37, 'PESQUISA PLANO 5', '"/Sindical/pesquisaPlano5.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 37);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 38, 'Inátivo (38)', '', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 38);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 39, 'PESQUISA TRANSFERÊNCIA', '"/Sindical/pesquisaTransferencia.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 39);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 40, 'PESQUISA GRUPO AGENDA', '"/Sindical/pesquisaGrupoAgenda.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 40);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 41, 'PESQUISA MOTIVO INATIVAÇÃO', '"/Sindical/pesquisaMotivoInativacao.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 41);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 42, 'PESQUISA CONVENÇÃO', '"/Sindical/pesquisaConvencao.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 42);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 43, 'PESQUISA SERVIÇOS', '"/Sindical/pesquisaServicos.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 43);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 44, 'PESQUISA TIPO SERVIÇO', '"/Sindical/pesquisaTipoServico.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 44);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 45, 'PESQUISA SERVIÇO VALOR', '"/Sindical/pesquisaServicoValor.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 45);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 46, 'PESQUISA CONTA COBRANÇA', '"/Sindical/pesquisaContaCobranca.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 46);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 47, 'PESQUISA CONTA BANCO', '"/Sindical/pesquisaContaBanco.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 47);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 48, 'PESQUISA ROTINA', '"/Sindical/pesquisaRotina.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 48);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 49, 'PESQUISA EVENTO', '"/Sindical/pesquisaEvento.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 49);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 50, 'PESQUISA MÓDULO', '"/Sindical/pesquisaModulo.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 50);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 51, 'PESQUISA PERMISSÃO', '"/Sindical/pesquisaPermissao.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 51);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 52, 'PESQUISA CONTABILIDADE', '"/Sindical/pesquisaContabilidade.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 52);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 53, 'PESQUISA GRUPO CIDADE', '"/Sindical/pesquisaGrupoCidade.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 53);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 54, 'PESQUISA ÍNDICE', '"/Sindical/pesquisaIndice.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 54);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 55, 'PERMISSÃO DEPARTAMENTO', '"/Sindical/permissaoDepartamento.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 55);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 56, 'MOTIVO INATIVAÇÃO', '"/Sindical/motivoInativacao.jsf"', 'MotivoInativacao' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 56);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 57, 'CONVENÇÃO', '"/Sindical/convencao.jsf"', 'Convencao' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 57);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 58, 'SERVIÇOS', '"/Sindical/servicos.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 58);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 59, 'TIPO SERVIÇO', '"/Sindical/tipoServico.jsf"', 'TipoServico' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 59);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 60, 'SERVIÇO VALOR', '"/Sindical/servicoValor.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 60);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 61, 'CONTA COBRANÇA', '"/Sindical/contaCobranca.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 61);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 62, 'ROTINA', '"/Sindical/rotina.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 62);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 63, 'EVENTO', '"/Sindical/evento.jsf"', 'Evento' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 63);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 64, 'MÓDULO', '"/Sindical/modulo.jsf"', 'Modulo' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 64);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 65, 'PERMISSÃO', '"/Sindical/permissao.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 65);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 66, 'CONSELHO', '"/Sindical/conselho.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 66);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 67, 'CNAE', '"/Sindical/cnae.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 67);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 68, 'USUÁRIO', '"/Sindical/usuario.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 68);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 69, 'DEPARTAMENTO', '"/Sindical/departamento.jsf"', 'Departamento' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 69);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 70, 'NÍVEL', '"/Sindical/nivel.jsf"', 'Nivel' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 70);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 71, 'PESSOA FÍSICA', '"/Sindical/pessoaFisica.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 71);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 72, 'USUÁRIO FALHOU', '"/Sindical/usuarioFalhou.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 72);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 73, 'ACESSO NEGADO', '"/Sindical/acessoNegado.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 73);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 74, 'BAIRRO', '"/Sindical/bairro.jsf"', 'Bairro' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 74);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 75, 'CIDADE', '"/Sindical/cidade.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 75);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 76, 'DESCRIÇÃO ENDEREÇO', '"/Sindical/descricaoEndereco.jsf"', 'DescricaoEndereco' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 76);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 77, 'LOGRADOURO', '"/Sindical/logradouro.jsf"', 'Logradouro' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 77);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 78, 'ENDEREÇO', '"/Sindical/endereco.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 78);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 79, 'TIPO ENDEREÇO', '"/Sindical/tipoEndereco.jsf"', 'TipoEndereco' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 79);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 80, 'PROFISSÃO', '"/Sindical/profissao.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 80);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 81, 'FILIAL', '"/Sindical/filial.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 81);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 82, 'PESSOA JURÍDICA', '"/Sindical/pessoaJuridica.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 82);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 83, 'TIPO DOCUMENTO', '"/Sindical/tipoDocumento.jsf"', 'TipoDocumento' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 83);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 84, 'PLANO', '"/Sindical/plano.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 84);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 85, 'CAIXA BANCO', '"/Sindical/caixaBanco.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 85);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 86, 'Inátivo (86)', '', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 86);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 87, 'TRANSFERÊNCIA ENTRE CONTAS', '"/Sindical/transferenciaEntreContas.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 87);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 88, 'AGENDA', '"/Sindical/agenda.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 88);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 89, 'GRUPO AGENDA', '"/Sindical/grupoAgenda.jsf"', 'GrupoAgenda' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 89);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 90, 'IMPRESSÃO BOLETOS', '"/Sindical/impressaoBoletos.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 90);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 91, 'CONTA BANCO', '"/Sindical/contaBanco.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 91);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 92, 'DESCONTO EMPREGADO', '"/Sindical/descontoEmpregado.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 92);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 93, 'SERVIÇO CONTA COBRANÇA', '"/Sindical/servicoContaCobranca.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 93);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 94, 'CNAE CONVENÇÃO', '"/Sindical/cnaeConvencao.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 94);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 95, 'MOVIMENTOS RECEBER', '"/Sindical/movimentosReceber.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 95);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 96, 'EXTRATO TELA', '"/Sindical/extratoTela.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 96);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 97, 'CONTRIBUIÇÃO', '"/Sindical/contribuicao.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 97);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 98, 'INATIVAÇÃO CONTRIBUINTES', '"/Sindical/inativacaoContribuintes.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 98);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 99, 'MENSAGEM', '"/Sindical/mensagem.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 99);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 101, 'ARQUIVO BANCO', '"/Sindical/arquivoBanco.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 101);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 102, 'GRUPO CIDADE', '"/Sindical/grupoCidade.jsf"', 'GrupoCidade' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 102);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 103, 'GRUPO CIDADES', '"/Sindical/grupoCidades.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 103);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 104, 'BAIXA GERAL', '"/Sindical/baixaGeral.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 104);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 105, 'ACORDO', '"/Sindical/acordo.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 105);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 106, 'PROCESSAMENTO INDIVIDUAL', '"/Sindical/processamentoIndividual.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 106);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 107, 'ÍNDICE MENSAL', '"/Sindical/indiceMensal.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 107);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 108, 'ÍNDICE', '"/Sindical/indice.jsf"', 'Indice' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 108);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 109, 'CORREÇÃO', '"/Sindical/correcao.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 109);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 110, 'RELATÓRIO MOVIMENTOS', '"/Sindical/relatorioMovimentos.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 110);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 111, 'REGISTRO EMPRESARIAL', '"/Sindical/registroEmpresarial.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 111);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 112, 'ENVIAR EMAIL', '"/Sindical/enviarEmail.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 112);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 113, 'AGENDAMENTO', '"/Sindical/agendamento.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 113);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 114, 'HOMOLOGAÇÃO', '"/Sindical/homologacao.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 114);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 115, 'FERIÁDOS', '"/Sindical/feriados.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 115);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 116, 'HORÁRIOS', '"/Sindical/horarios.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 116);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 117, 'RETORNO BANCO', '"/Sindical/retornoBanco.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 117);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 118, 'CONTRIBUIÇÃO ASSOCIATIVO', '"/Sindical/contribuicaoSocio.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 118);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 119, 'CONTRIBUIÇÃO POR SOCIO', '"/Sindical/contribuicaoPorSocio.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 119);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 120, 'MATRÍCULA SÓCIO', '"/Sindical/socios.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 120);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 121, 'MATRÍCULA CONVÊNIO MÉDICO', '"/Sindical/convenioMedico.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 121);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 122, 'MATRÍCULA ACADEMIA', '"/Sindical/academia.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 122);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 123, 'CONVÊNIO', '"/Sindical/convenio.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 123);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 124, 'SUB GRUPO CONVÊNIO', '"/Sindical/subGrupoConvenio.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 124);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 125, 'GRUPO CONVÊNIO', '"/Sindical/grupoConvenio.jsf"', 'GrupoConvenio' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 125);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 126, 'SERVIÇO ROTINA', '"/Sindical/servicoRotina.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 126);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 127, 'PARENTESCO', '"/Sindical/parentesco.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 127);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 128, 'SUSPENÇÃO', '"/Sindical/suspencao.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 128);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 129, 'GRUPO CATEGORIA', '"/Sindical/grupoCategoria.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 129);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 130, 'CATEGORIA', '"/Sindical/categoria.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 130);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 131, 'LANÇAMENTO INDIVIDUAL', '"/Sindical/lancamentoIndividual.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 131);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 132, 'EMISSÃO DE GUIAS', '"/Sindical/emissaoGuias.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 132);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 133, 'EMISSÃO DE CARTEIRINHA', '"/Sindical/emissaoCarteirinha.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 133);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 134, 'EXTORNAR BOLETO', '"/Sindical/extratoTela1.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 134);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 135, 'EXCLUIR ACORDO', '"/Sindical/extratoTela2.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 135);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 136, 'ALTERAR DATA DE VENCIMENTO', '"/Sindical/extratoTela3.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 136);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 137, 'BAIXA POR BOLETO', '"/Sindical/baixaBoleto.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 137);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 138, 'AGENDAMENTO CARAVANA', '"/Sindical/caravana.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 138);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 139, 'AGENDA BAILE', '"/Sindical/baile.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 139);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 140, 'CADASTRO BANDAS', '"/Sindical/bandas.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 140);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 141, 'VENDAS BAILE', '"/Sindical/vendasBaile.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 141);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 142, 'VENDAS CARAVANA', '"/Sindical/vendasCaravana.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 142);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 143, 'DESCRIÇÃO EVENTO', '"/Sindical/descricaoEvento.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 143);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 144, 'Inátivo (144)', '', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 144);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 145, 'Inátivo (145)', '', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 145);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 146, 'VENDEDOR', '"/Sindical/vendedor.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 146);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 147, 'EFINANCEIRO', '"/Sindical/eFinanceiro.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 147);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 148, 'PROFESSOR', '"/Sindical/professor.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 148);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 149, 'COMPONENTE CURRICULAR', '"/Sindical/componenteCurricular.jsf"', 'ComponenteCurricular' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 149);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 150, 'TURMA', '"/Sindical/turma.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 150);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 151, 'MATRÍCULA ESCOLA', '"/Sindical/matriculaEscola.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 151);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 152, 'PESQUISA SOCIOS', '"/Sindical/pesquisaSocios.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 152);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 153, 'LISTA FILTRO EXTRATO', '"/Sindical/extratoTela4.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 153);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 154, 'CADASTRO SIMPLES', '"/Sindical/simples.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 154);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 155, 'TIPO PAGAMENTO', '"/Sindical/tipoPagamento.jsf"', 'TipoPagamento' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 155);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 156, 'GRUPO EVENTO', '"/Sindical/grupoEvento.jsf"', 'GrupoEvento' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 156);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 157, 'MAC FILIAL', '"/Sindical/macFilial.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 157);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 158, 'CATÁLOGO FILME', '"/Sindical/catalogoFilme"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 158);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 159, 'MÍDIA', '"/Sindical/midia"', 'Midia' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 159);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 160, 'TÍTULO', '"/Sindical/titulo"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 160);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 161, 'PESQUISA TÍTULOS', '"/Sindical/pesquisaTitulo.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 161);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 162, 'GENERO', '"/Sindical/genero.jsf"', 'Genero' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 162);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 163, 'OPOSIÇÃO', '"/Sindical/oposicao.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 163);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 164, 'REGISTRO PATRONAL', '"/Sindical/registroPatronal.jsf"', 'Patronal' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 164);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 165, 'VALOR EXTRATO TELA', '"/Sindical/extratoTela5.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 165);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 166, 'ATENDIMENTO OPERAÇÃO', '"/Sindical/atendimentoOperacao.jsf"', 'AteOperacao' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 166);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 167, 'ATENDIMENTO PESSOA', '', 'AtePessoa' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 167);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 168, 'ATENDIMENTO MOVIMENTO', '"/Sindical/atendimento.jsf"', 'AteMovimento' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 168);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 169, 'RECEPÇÃO', '"/Sindical/recepcao.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 169);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 170, 'CARTÃO SOCIAL', '"/Sindical/cartaoSocial.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 170);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 171, 'RELATÓRIO DE SÓCIOS', '"/Sindical/relatorioSocios.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 171);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 172, 'PERÍODO CONVENÇÃO', '"/Sindical/periodoConvencao.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 172);
-- INSERT INTO seg_rotina (id, ds_rotina, ds_nome_pagina, ds_classe) SELECT 173, 'FECHAMENTO COMISSÃO', '"/Sindical/fechamentoComissaoAcordo.jsf"', '' WHERE NOT EXISTS ( SELECT id FROM seg_rotina WHERE id = 173);
