...
INSERT INTO matr_contrato_campos (id, ds_campo, ds_variavel, id_modulo) SELECT 57, 'Valor parcela com desconto',    '$valorParcelaComDesconto',     8 WHERE NOT EXISTS ( SELECT id FROM matr_contrato_campos WHERE id = 57);
