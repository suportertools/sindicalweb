...
//
//public class VendasCaravanaJSFBean {
...
//        chamadaPaginaJSFBean chamada = new chamadaPaginaJSFBean();
//        List<Movimento> movs = new ArrayList();
//        Movimento movimento = new Movimento();
//        List<ComplementoValor> compls = new ArrayList();
...
//        OperacaoMovimento op = new OperacaoMovimento(movs);
//        if (pessoa.getId() == -1){
...
//            op = new OperacaoMovimento(movs);
//            op.setLista(movs);
//            FacesContext.getCurrentInstance().getExternalContext().getSessionMap().put("arrayBaixa", op);
//            novoVoid();
