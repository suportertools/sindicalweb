...
public class BiometriaAtualizaCatraca implements Serializable {
    ...
    @Column(name = "id")
    private Integer id;
    @Column(name = "is_aparelho1", columnDefinition = "boolean default true", nullable = false)
    private Boolean aparelho1;
    @Column(name = "is_aparelho2", columnDefinition = "boolean default true", nullable = false)
    private Boolean aparelho2;
    @Column(name = "is_aparelho3", columnDefinition = "boolean default true", nullable = false)
    private Boolean aparelho3;
    @Column(name = "is_aparelho4", columnDefinition = "boolean default true", nullable = false)
