...
@NamedQueries({
    @NamedQuery(name = "Nacionalidade.pesquisaID", query = "SELECT NAC FROM Nacionalidade AS NAC WHERE NAC.id = :pid"),
...
public class Nacionalidade implements BaseEntity, Serializable {
