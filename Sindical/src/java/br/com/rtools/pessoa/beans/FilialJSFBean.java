...
public class FilialJSFBean {
    ...
    public void salvarCidadeFilial(Cidade cid, int index){
        ...
        //for(int i = 0; i < listaCidade.size();i++){
            ...
            if ( iFilial != -1){
                ...
                if ( filialCidade.getId() != -1){
                    ...
                    FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, "Sucesso", "Cidade atualizada com Sucesso!"));
    ...
    public String excluir(Filial fi){
        if (fi.getId() != -1){
            SalvarAcumuladoDB sv = new SalvarAcumuladoDBToplink();
            sv.abrirTransacao();
            filial = (Filial) sv.pesquisaCodigo(fi.getId(), "Filial");
