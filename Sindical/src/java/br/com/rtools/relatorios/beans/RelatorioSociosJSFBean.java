...
public class RelatorioSociosJSFBean {
    ...
    public String editarOpcao(int index){
        ...
        if (index == 0){
            if (booMatricula) booMatricula = false; else booMatricula = true;
        }else if (index == 1){
            if (booIdade) booIdade = false; else booIdade = true;
        }else if (index == 2){
            if (booGrupoCategoria) booGrupoCategoria = false; else booGrupoCategoria = true;
        }else if (index == 3){
            if (booSexo) booSexo = false; else booSexo = true;
        }else if (index == 4){
            if (booGrau) booGrau = false; else booGrau = true;
        }else if (index == 5){
            if (booFotos) booFotos = false; else booFotos = true;
        }else if (index == 6){
            if (booCarteirinha) booCarteirinha = false; else booCarteirinha = true;
        }else if (index == 7){
            if (booTipoCobranca) booTipoCobranca = false; else booTipoCobranca = true;
        }else if (index == 8){
            if (booCidadeSocio) booCidadeSocio = false; else booCidadeSocio = true;
        }else if (index == 9){
            if (booCidadeEmpresa) booCidadeEmpresa = false; else booCidadeEmpresa = true;
        }else if (index == 10){
            if (booAniversario) booAniversario = false; else booAniversario = true;
        }else if (index == 11){
            if (booData) booData = false; else booData = true;
        }else if (index == 12){
            if (booVotante) booVotante = false; else booVotante = true;
        }else if (index == 13){
            if (booEmail) booEmail = false; else booEmail = true;
        }else if (index == 14){
            if (booTelefone) booTelefone = false; else booTelefone = true;
        }else if (index == 15){
            if (booEstadoCivil) booEstadoCivil = false; else booEstadoCivil = true;
        }else if (index == 16){
